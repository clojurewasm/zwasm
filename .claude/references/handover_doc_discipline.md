# Handover doc discipline — full detail

> **Doc-state**: ACTIVE. Reference (no `paths:` frontmatter → read on demand only). Stub: [`../rules/handover_doc_discipline.md`](../rules/handover_doc_discipline.md).
