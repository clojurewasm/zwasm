# Lessons vs ADRs — when to use which — full detail

> **Doc-state**: ACTIVE. Reference (no `paths:` frontmatter → read on demand only). Stub: [`../rules/lessons_vs_adr.md`](../rules/lessons_vs_adr.md).
