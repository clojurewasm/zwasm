# No single slot serving two semantic axes — full detail

> **Doc-state**: ACTIVE. Reference (no `paths:` frontmatter → read on demand only). Stub: [`../rules/single_slot_dual_meaning.md`](../rules/single_slot_dual_meaning.md).
