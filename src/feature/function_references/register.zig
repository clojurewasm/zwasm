...
//! reference table (`feature/function_references/` subsystem).
//!
//! `register(*DispatchTable)` is the canonical hook — when the
//! build flag `-Denable=function_references` selects this feature in, the
...
//! Phase row opens.
//!
//! Zone 1 (`src/feature/function_references/`).
