...
//! reference table (`feature/exception_handling/` subsystem).
//!
//! `register(*DispatchTable)` is the canonical hook — when the
//! build flag `-Denable=exception_handling` selects this feature in, the
...
//! Phase row opens.
//!
//! Zone 1 (`src/feature/exception_handling/`).
