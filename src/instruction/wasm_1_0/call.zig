//! `call` — Wasm 1.0 call op. Per-op file (Zone 1 identity
...
fn validate_call() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_call() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_call() collector.DispatchError!void {
    return error.NotMigrated;
}
