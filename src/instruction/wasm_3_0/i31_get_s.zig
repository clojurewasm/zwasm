//! `i31.get_s` — Wasm 3.0 GC proposal (ref/cast + i31 cohort).
//!
...
pub const op_tag: ZirOp = .@"i31.get_s";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_i31_get_s,
    .lower = lower_i31_get_s,
    .interp = interp_i31_get_s,
};

fn validate_i31_get_s() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_i31_get_s() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_i31_get_s() collector.DispatchError!void {
    return error.NotMigrated;
}
