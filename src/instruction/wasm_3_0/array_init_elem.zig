//! `array.init_elem` — Wasm 3.0 GC proposal (array cohort).
//!
...
pub const op_tag: ZirOp = .@"array.init_elem";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_array_init_elem,
    .lower = lower_array_init_elem,
    .interp = interp_array_init_elem,
};

fn validate_array_init_elem() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_array_init_elem() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_array_init_elem() collector.DispatchError!void {
    return error.NotMigrated;
}
