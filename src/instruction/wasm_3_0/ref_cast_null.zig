//! `ref.cast_null` — Wasm 3.0 GC proposal (ref/cast + i31 cohort).
//!
...
pub const op_tag: ZirOp = .@"ref.cast_null";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_ref_cast_null,
    .lower = lower_ref_cast_null,
    .interp = interp_ref_cast_null,
};

fn validate_ref_cast_null() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_ref_cast_null() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_ref_cast_null() collector.DispatchError!void {
    return error.NotMigrated;
}
