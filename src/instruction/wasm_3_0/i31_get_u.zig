//! `i31.get_u` — Wasm 3.0 GC proposal (ref/cast + i31 cohort).
//!
...
pub const op_tag: ZirOp = .@"i31.get_u";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_i31_get_u,
    .lower = lower_i31_get_u,
    .interp = interp_i31_get_u,
};

fn validate_i31_get_u() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_i31_get_u() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_i31_get_u() collector.DispatchError!void {
    return error.NotMigrated;
}
