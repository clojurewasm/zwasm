//! `ref.i31` — Wasm 3.0 GC proposal (ref/cast + i31 cohort).
//!
...
pub const op_tag: ZirOp = .@"ref.i31";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_ref_i31,
    .lower = lower_ref_i31,
    .interp = interp_ref_i31,
};

fn validate_ref_i31() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_ref_i31() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_ref_i31() collector.DispatchError!void {
    return error.NotMigrated;
}
