//! `any.convert_extern` — Wasm 3.0 GC proposal (ref/cast + i31 cohort).
//!
...
pub const op_tag: ZirOp = .@"any.convert_extern";
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_any_convert_extern,
    .lower = lower_any_convert_extern,
    .interp = interp_any_convert_extern,
};

fn validate_any_convert_extern() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_any_convert_extern() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_any_convert_extern() collector.DispatchError!void {
    return error.NotMigrated;
}
