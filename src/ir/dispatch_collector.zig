...
test "migratedOpCount tracks collected_ops length (12 after §9.12-B / B14 i64 cohort)" {
    // B1: i32.add; B13: + i32 cohort (5); B14: + i64 cohort (6).
    try std.testing.expectEqual(@as(usize, 12), migratedOpCount());
}
