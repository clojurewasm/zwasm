...
pub fn emitGlobalGet(ctx: *EmitCtx, ins: *const ZirInstr) Error!void {
    ...
    switch (shape.vt) {
        ...
        .i64, .funcref, .externref, .i31ref => try emitI64GlobalGet(ctx, globalidx, shape.byte_off),
...
pub fn emitGlobalSet(ctx: *EmitCtx, ins: *const ZirInstr) Error!void {
    ...
    switch (shape.vt) {
        ...
        .i64, .funcref, .externref, .i31ref => try emitI64GlobalSet(ctx, globalidx, shape.byte_off),
