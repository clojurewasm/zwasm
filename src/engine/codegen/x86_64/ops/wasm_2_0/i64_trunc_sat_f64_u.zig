...
//! unsigned-to-i64 family adapter wrapping `emitFpTruncSatU64`).
//!
//! Wasm spec §4.3 (i64.trunc_sat_f64_u) — non-trapping saturating
//! unsigned f64→i64.
//!
...
const meta = @import("../../../../../instruction/wasm_2_0/i64_trunc_sat_f64_u.zig");
...
pub fn emit(ctx: *ctx_mod.EmitCtx, ins: *const zir.ZirInstr) ctx_mod.Error!void {
    return op_convert.emitI64TruncSatF64U(ctx, ins);
}
