//! x86_64 emit handler for `i32.or` — Zone 2 per-arch op file per
//! ADR-0074 + ADR-0075.
//!
//! Identity anchor at `src/instruction/wasm_1_0/i32_or.zig`.
...
const meta = @import("../../../../../instruction/wasm_1_0/i32_or.zig");
