...
//!
//! Wasm spec §4.4.1 (i64.rem_s) — signed 64-bit integer remainder;
//! traps on divisor=0. Note: `INT64_MIN % -1` does NOT trap
//! (returns 0).
//! Intel SDM Vol 2A `IDIV r/m64` — sign-extended dividend in
//! RDX:RAX; remainder in RDX.
//!
//! Registered in `dispatch_collector.collected_x86_64_ctx_ops`.
//!
//! Zone 2 (`src/engine/codegen/x86_64/ops/`).

const meta = @import("../../../../../instruction/wasm_1_0/i64_rem_s.zig");
...
pub fn emit(ctx: *ctx_mod.EmitCtx, ins: *const zir.ZirInstr) ctx_mod.Error!void {
    return op_alu_int.emitI64RemS(ctx, ins);
}
