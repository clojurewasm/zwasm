...
pub const encPaddB = inst_sse.encPaddB;
pub const encPaddW = inst_sse.encPaddW;
pub const encPaddD = inst_sse.encPaddD;
pub const encPaddQ = inst_sse.encPaddQ;
pub const encPsubB = inst_sse.encPsubB;
pub const encPsubW = inst_sse.encPsubW;
pub const encPsubD = inst_sse.encPsubD;
...
pub const encPmuldq = inst_sse.encPmuldq;
...
pub const encAddps = inst_sse.encAddps;
pub const encSubps = inst_sse.encSubps;
pub const encMulps = inst_sse.encMulps;
pub const encDivps = inst_sse.encDivps;
pub const encSqrtps = inst_sse.encSqrtps;
pub const encAddpd = inst_sse.encAddpd;
pub const encSubpd = inst_sse.encSubpd;
pub const encMulpd = inst_sse.encMulpd;
pub const encDivpd = inst_sse.encDivpd;
pub const encSqrtpd = inst_sse.encSqrtpd;
pub const encMinps = inst_sse.encMinps;
pub const encMaxps = inst_sse.encMaxps;
pub const encMinpd = inst_sse.encMinpd;
pub const encMaxpd = inst_sse.encMaxpd;
pub const encOrps = inst_sse.encOrps;
pub const encOrpd = inst_sse.encOrpd;
pub const encXorps = inst_sse.encXorps;
pub const encXorpd = inst_sse.encXorpd;
pub const encAndnps = inst_sse.encAndnps;
pub const encAndnpd = inst_sse.encAndnpd;
pub const encPslldImm = inst_sse.encPslldImm;
...
pub const encRoundpd = inst_sse.encRoundpd;
pub const encPsrlwImm = inst_sse.encPsrlwImm;
pub const encPsllwImm = inst_sse.encPsllwImm;
pub const encPsrldImm = inst_sse.encPsrldImm;
pub const encCmpps = inst_sse.encCmpps;
pub const encCmppd = inst_sse.encCmppd;
pub const encPsllwReg = inst_sse.encPsllwReg;
pub const encPslldReg = inst_sse.encPslldReg;
pub const encPsllqReg = inst_sse.encPsllqReg;
pub const encPsrlwReg = inst_sse.encPsrlwReg;
pub const encPsrldReg = inst_sse.encPsrldReg;
...
pub const encPsubq = inst_sse.encPsubq;
pub const encPunpcklbw = inst_sse.encPunpcklbw;
pub const encPunpckhbw = inst_sse.encPunpckhbw;
pub const encCvtdq2ps = inst_sse.encCvtdq2ps;
pub const encCvtps2pd = inst_sse.encCvtps2pd;
pub const encCvtpd2ps = inst_sse.encCvtpd2ps;
pub const encCvtdq2pd = inst_sse.encCvtdq2pd;
pub const encPabsb = inst_sse.encPabsb;
pub const encPabsw = inst_sse.encPabsw;
pub const encPabsd = inst_sse.encPabsd;
pub const encPmovsxbw = inst_sse.encPmovsxbw;
pub const encPmovsxwd = inst_sse.encPmovsxwd;
pub const encPmovsxdq = inst_sse.encPmovsxdq;
pub const encPmovzxbw = inst_sse.encPmovzxbw;
pub const encPmovzxwd = inst_sse.encPmovzxwd;
pub const encPmovzxdq = inst_sse.encPmovzxdq;
pub const encPacksswb = inst_sse.encPacksswb;
pub const encPackssdw = inst_sse.encPackssdw;
pub const encPackuswb = inst_sse.encPackuswb;
pub const encPackusdw = inst_sse.encPackusdw;
pub const encMovmskps = inst_sse.encMovmskps;
pub const encMovmskpd = inst_sse.encMovmskpd;
pub const encPmovmskb = inst_sse.encPmovmskb;
pub const encPand = inst_sse.encPand;
pub const encPor = inst_sse.encPor;
pub const encPandn = inst_sse.encPandn;
pub const encPtest = inst_sse.encPtest;
