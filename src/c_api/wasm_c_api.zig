...
// `wasi.zig` owns these `pub export fn`s after the §9.5 / 5.0
// carve-out (ADR-0007); re-export them so existing call sites
// (tests, cli/run.zig) keep working through `wasm_c_api.<name>`.
