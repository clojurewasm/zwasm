...
;;
;; Run: zwasm run --invoke extend8 examples/wat/sign_extend.wat 255
;; Output: 4294967295 (= -1 as i32, sign-extended from 0xFF)
;; Run: zwasm run --invoke extend8 examples/wat/sign_extend.wat 127
;; Output: 127
;; Run: zwasm run --invoke extend16 examples/wat/sign_extend.wat 65535
