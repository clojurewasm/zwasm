...
| Date       | SHA          | Note                                                                                                                                                                                                                                                                                                                       |
|------------|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-05-02 | `f51bce80` | Initial. Phase-2 Wasm 2.0 curated corpus (50 corpora / 1158 modules). §"Consequences / Negative" deferred final corpus-completeness pass to "Phase 15".                                                                                                                                                                          |
| 2026-05-12 | `171bbd36` | Per ADR-0056 §"Decision" — the deferred "Phase 15 final corpus-completeness pass" clause is amended: for the Wasm 2.0 corpus (incl. SIMD), the completeness pass is absorbed into Phase 9 close (this is the Phase 9 / Wasm 2.0 completion phase by design). Phase 15 retains responsibility for post-Wasm-2.0 corpus widening only. |
