...
| Date | SHA | Note |
|---|---|---|
| 2026-05-09 | `ba88328a` | Initial accepted version (§9.9/9.2 design framing; shape-as-variant ZirOp catalogue + FP-class pool reuse with shape-tag axis + feature-register pattern + NEON spec-fidelity + SSE4.1 minimum) |
