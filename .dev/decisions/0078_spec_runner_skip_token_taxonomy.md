...
| `SKIP-WIN64-CALL-INDIRECT-TRAP`| `debt-trackable`  | D-163 — CLOSED 2026-05-23 (R3 stack-probe `17917f070` repaired the trap path; SKIP arm removed `c4b3093a6`; latest closure affirmation `d9d525a4`). Token no longer emitted; row retained for citation lineage |
