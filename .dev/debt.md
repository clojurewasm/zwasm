...
| D-015 | doc    | blocked-by: ADR-0014 amend (B-β) lands the inline content | Survey notes (`p6-6K1-survey.md` / `p6-6K3-survey.md` / `p6-6K3-lifetime-survey.md`) live in gitignored `private/notes/`. Load-bearing parts will be inlined into ADR-0014 §3.γ + §6.K.3 in Step B-β; remaining survey content stays in private/ as scratch. | 2026-05-04 | `private/notes/p6-6K1-survey.md`, `p6-6K3-survey.md`, `p6-6K3-lifetime-survey.md` |
