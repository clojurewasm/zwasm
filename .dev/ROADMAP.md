...
| 9.9  | `simd.wast` spec test wired in; fail=skip=0 across both backends (3-host gate). Sub-chunks 9.9-a..* recorded in [`.dev/phase_log/phase9.md`](../phase_log/phase9.md#row-99--simdwast-spec-test-wiring) (extracted 2026-05-11; ROADMAP per §18 stays a now-snapshot). | [x] (Mac+OrbStack green; windowsmini = D-084) |
...
| 9.12 | 🔒 Phase 10 entry gate review ([`.dev/phase10_transition_gate.md`](../phase10_transition_gate.md)) — collaborative review per Track D; the loop's hard-gate detector surfaces this row on next resume. | [ ]            |
