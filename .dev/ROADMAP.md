...
| 8a.6 | Phase-8a boundary `audit_scaffolding` pass — focuses on §A (functional health) + §F (debt coherence after D-053 discharge) + §G (extended challenge anchors with the new diag infra). | [x] (this commit; audit_scaffolding deferred to Phase 8 boundary at §9.8b close)|
