...
Stage 7.2: table.size/grow i64 variants in vm.zig.

## Previous Task

7.1: Extended Limits to u64 with is_64 flag. readLimits handles flags 0x04-0x07.
Spec: 30,666→30,703 (100%). All 37 table_size64+memory_grow64 failures fixed.
