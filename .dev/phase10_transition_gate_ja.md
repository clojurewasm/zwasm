...
- I5: `.dev/debt.md` に `trigger-not-fired` masquerade なし
...
- `.dev/debt.md`: D-026 (emcc env-stub host-func wiring; Phase 11), D-058 / D-059 (Phase 10 boundary audit deliverables), D-074 (Phase 11 bench infra), D-082 (D-072 (c)-path), D-171 / D-172 / D-173 (c_api scalar accessors; Phase F = Phase 10 open)
